...
const Sidebar: FC<SidebarProps> = ({
  ...
  const navItems = [
    { section: 'map', label: 'Widok mapy', icon: (
    ...
    { section: 'analytics', label: 'Analityka', icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
    )},
    { section: 'compare', label: 'Porównanie', icon: (
    ...
    >
      ...
      <div className="sidebar-footer">
        <div className="zoom-info">
          <span className="zoom-label">Przybliżenie</span>
        ...
        >
          ...
          <span className="nav-label">Czat AI</span>
          <div className="nav-indicator"></div>
        </a>
        <a
          href="#"
        ...
        >
          ...
          <span className="nav-label">Leć do Polski</span>
          <div className="nav-indicator"></div>
        </a>
        ...
        <button className="sidebar-collapse-btn" onClick={onCollapseToggle} aria-label={collapsed ? 'Rozwiń panel boczny' : 'Zwiń panel boczny'}>
