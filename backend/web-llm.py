...
def get_rce(file_path: str = "C:/Users/Piotr/source/repos/pradus-and-voltus/Demo-Dataset/Rynkowa cena energii elektrycznej (RCE) 2026-04-13 - 2026-04-18.xlsx"):
    try:
...
def run_voltus(user_prompt: str, model: str = "gemma4:e2b"):
    ...
    try:
        ...
        system_prompt = f"""Jesteś Voltus, inteligentny doradca energetyczny TAURONA. 
...
if __name__ == "__main__":
    ...
    print("Łączę z Voltusiem \n")
    run_voltus(user_prompt)
